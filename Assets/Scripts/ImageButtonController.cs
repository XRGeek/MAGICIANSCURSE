...
public class ImageButtonController : MonoBehaviour
{
    ...
    public void ImageButtonOnClick()
    {
        ...
        else if (fmt == TextureFormat.ASTC_4x4 ||
            fmt == TextureFormat.ASTC_4x4 ||
            fmt == TextureFormat.ASTC_5x5 ||
            fmt == TextureFormat.ASTC_6x6 ||
            fmt == TextureFormat.ASTC_8x8 ||
            fmt == TextureFormat.ASTC_10x10 ||
            fmt == TextureFormat.ASTC_12x12 ||
            fmt == TextureFormat.ASTC_4x4 ||
            fmt == TextureFormat.ASTC_4x4 ||
            fmt == TextureFormat.ASTC_5x5 ||
            fmt == TextureFormat.ASTC_6x6 ||
