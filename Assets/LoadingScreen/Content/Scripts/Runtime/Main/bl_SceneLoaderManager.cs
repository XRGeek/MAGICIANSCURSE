...
namespace Lovatto.SceneLoader
{
    public class bl_SceneLoaderManager : ScriptableObject
    {
        ...
        */
#if !ODIN_INSPECTOR
        [Header("Tips English"), ReorderableLovatto("Tips English")]
#endif
        public TheTipList TipListEnglish;
#if !ODIN_INSPECTOR
        [Header("Tips French"), ReorderableLovatto("Tips French")]
#endif
        public TheTipList TipListFrench;
#if !ODIN_INSPECTOR
        [Header("Tips German"), ReorderableLovatto("Tips German")]
#endif
        public TheTipList TipListGerman;
        ...
        public bool HasTips
        {
            get
            {
                return (TipListEnglish != null && TipListEnglish.Count > 0);
            }
        }
