...
#define _MinimumGlow_arr RRF_HumanShadersEyeShadersEyeShader_Model3
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float2 uv_TexCoord3_g39 = i.uv_texcoord * temp_cast_1;
			float simplePerlin3D4_g39 = snoise( float3( uv_TexCoord3_g39 ,  0.0 ) );
			float2 appendResult6_g39 = (float2(simplePerlin3D4_g39 , simplePerlin3D4_g39));
			float4 appendResult572 = (float4(appendResult6_g39 , 1.0 , 0.0));
			...
			float temp_output_2_0_g42 = ( _EyeShadingPower * 0.5 );
			float temp_output_3_0_g42 = ( 1.0 - temp_output_2_0_g42 );
			float3 appendResult7_g42 = (float3(temp_output_3_0_g42 , temp_output_3_0_g42 , temp_output_3_0_g42));
			float3 eyeShading672 = ( ( temp_cast_8 * temp_output_2_0_g42 ) + appendResult7_g42 );
			...
			float dotResult4_g24 = dot( ase_worldlightDir , temp_cast_10 );
			...
			float3 temp_cast_16 = (pow( ( clampResult7_g40 * clampResult8_g40 ) , _EyeShadingPower )).xxx;
			...
			float4 lerpResult568 = lerp( ( temp_output_326_0 * float4( ( clampResult478 * ( ( temp_cast_16 * temp_output_2_0_g41 ) + appendResult7_g41 ) ) , 0.0 ) ) , float4( 0,0,0,0 ) , eyeLimbalRingPower612);
...
/*ASEBEGIN
Version=16204
880;442;1009;462;-1523.644;-1136.168;2.818975;True;False
...
Node;AmplifyShaderEditor.CommentaryNode;635;-3474.641,-314.61;Float;False;1296.923;486.1872;Eye Local UV setup and RGB masking for Sclera, Limbal Ring and Iris Area;11;633;410;590;584;166;605;705;706;707;721;591;RGB Mixer map;1,1,1,1;0;0
Node;AmplifyShaderEditor.GetLocalVarNode;605;-3389.858,-91.25156;Float;False;604;eyeSizeUVs;1;0;OBJECT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SamplerNode;166;-3081.737,-257.9168;Float;True;Property;_RGBMask;RGBMask;0;1;[NoScaleOffset];Create;True;0;0;False;1;Header(Main Textures);d0431c3a16ed8b54c8d648bb79ca09a5;ea1c686f188c8ef46b8c015f1c344441;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.CommentaryNode;693;-6657.773,-1941.334;Float;False;889.9717;218.2189;Comment;4;685;690;691;692;GetLightColorIntensity;1,1,1,1;0;0
Node;AmplifyShaderEditor.LightColorNode;685;-6625.374,-1893.515;Float;False;0;3;COLOR;0;FLOAT3;1;FLOAT;2
...
Node;AmplifyShaderEditor.SimpleSubtractOpNode;705;-2699.987,-67.25137;Float;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.BreakToComponentsNode;690;-6441.943,-1882.795;Float;False;FLOAT3;1;0;FLOAT3;0,0,0;False;16;FLOAT;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT;5;FLOAT;6;FLOAT;7;FLOAT;8;FLOAT;9;FLOAT;10;FLOAT;11;FLOAT;12;FLOAT;13;FLOAT;14;FLOAT;15
Node;AmplifyShaderEditor.LerpOp;706;-2435.563,-16.65071;Float;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;691;-6151.062,-1889.845;Float;False;3;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ClampOpNode;721;-2309.206,6.238053;Float;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.CommentaryNode;631;-5732.188,-1686.254;Float;False;1277.707;559.7808;PupilControl;9;587;543;555;91;542;537;535;536;686;Pupil Control;1,1,1,1;0;0
Node;AmplifyShaderEditor.SimpleDivideOpNode;692;-5920.385,-1873.472;Float;False;2;0;FLOAT;0;False;1;FLOAT;3;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;587;-5682.188,-1524.082;Float;False;585;IrisPupil_MASK;1;0;OBJECT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;584;-3424.641,63.08065;Float;False;583;ParallaxOffset_Vec2;1;0;OBJECT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;410;-3143.635,-18.3141;Float;False;2;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.CommentaryNode;219;-1716.819,1929.655;Float;False;2546.831;732.6423;IrisConeCaustics;20;376;373;50;334;370;634;737;745;750;757;759;760;761;762;781;782;779;763;811;824;Caustics;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;737;-795.378,2360.672;Float;False;732;FresnelLight;1;0;OBJECT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;759;-562.4992,2366.532;Float;False;ConstantBiasScale;-1;;33;63208df05c83e8e49a48ffbdce2e43a0;0;3;3;FLOAT;0;False;1;FLOAT;0.5;False;2;FLOAT;1.25;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;811;-583.9844,1967.001;Float;False;809;BaseIrisColors;1;0;OBJECT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;757;-263.9395,2337.472;Float;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.CommentaryNode;475;-1700.735,2697.333;Float;False;1855.592;580.5686;Eye Shading - Created local shadows around the eye (fake AO);13;672;461;466;462;459;484;465;483;464;457;463;458;467;Eye Shading;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;334;260.7897,2022.928;Float;False;3;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;760;9.352644,2231.054;Float;False;3;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ObjectToWorldTransfNode;457;-1638.375,2904.376;Float;False;1;0;FLOAT4;0,-3,1,0.78;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ObjectToWorldTransfNode;462;-1650.735,3082.156;Float;False;1;0;FLOAT4;0,1.2,1,0.78;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.WorldNormalVector;459;-1644.911,2747.333;Float;False;False;1;0;FLOAT3;0,0,1;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.SimpleAddOpNode;763;397.4344,1914.998;Float;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleAddOpNode;762;234.1925,2220.282;Float;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.DotProductOpNode;461;-1343.11,2985.45;Float;False;2;0;FLOAT3;0,0,0;False;1;FLOAT4;0,0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.DotProductOpNode;458;-1338.131,2816.313;Float;False;2;0;FLOAT3;0,0,0;False;1;FLOAT4;0,0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;761;431.1953,2104.292;Float;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.CommentaryNode;652;2682.394,1397.634;Float;False;950.9968;628.9937;Final Outputs and Pupil Color control;14;648;643;646;664;665;647;666;668;667;650;673;674;832;833;Final Gather;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.ClampOpNode;464;-1110.505,2800.719;Float;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.ClampOpNode;465;-1102.694,2956.886;Float;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ClampOpNode;745;657.967,2126.984;Float;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;1,1,1,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;463;-878.1376,2862.101;Float;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;669;-43.51121,-496.9287;Float;False;MicroScatterScale_vec2;36;;39;27afac86e902b3f4680f2698fbeab237;0;0;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;484;-726.0908,3109.957;Float;False;2;2;0;FLOAT;0;False;1;FLOAT;0.5;False;1;FLOAT;0
Node;AmplifyShaderEditor.PowerNode;466;-721.2878,2889.497;Float;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;483;-439.5578,2937.341;Float;False;Lerp White To;-1;;42;047d7c189c36a62438973bad9d37b1c2;0;2;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;790;3196.831,409.8283;Float;True;732;FresnelLight;1;0;OBJECT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;780;3180.02,606.7944;Float;True;779;LightComponent;1;0;OBJECT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;646;3168.31,1518.499;Float;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;785;3518.789,722.4212;Float;True;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;793;3519.296,515.304;Float;True;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ClampOpNode;795;3764.5,737.1391;Float;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;1,1,1,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;674;3447.683,1541.704;Float;False;2;2;0;FLOAT3;0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ClampOpNode;794;3754.959,510.9361;Float;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;1,1,1,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.LightColorNode;796;4065.512,548.1868;Float;False;0;3;COLOR;0;FLOAT3;1;FLOAT;2
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;5977.844,1606.051;Float;False;True;2;Float;ASEMaterialInspector;0;0;Standard;RRF_HumanShaders/EyeShaders/EyeShader_Model3;False;False;False;False;False;False;False;False;False;False;False;False;False;True;False;False;False;False;False;False;Back;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Opaque;0.5;True;True;0;False;Opaque;;Geometry;ForwardOnly;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;True;0;0;False;-1;0;False;-1;0;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;-1;-1;-1;-1;0;False;0;0;False;-1;-1;0;False;-1;0;0;0;False;16;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=67CE8C930BADF816B7A34D5892C2AE2F872478C9