...
Shader "RRF_HumanShaders/EyeShaders/EyeShader_Model4"
{
	Properties
	{
		...
		_DirectionalLightSourcePower1("DirectionalLightSourcePower", Range( 0 , 1)) = 1
	...
	SubShader
	{
		...
		uniform float _DirectionalLightSourcePower1;
...
#define _MinimumGlow_arr RRF_HumanShadersEyeShadersEyeShader_Model4
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float2 uv_TexCoord3_g53 = i.uv_texcoord * temp_cast_1;
			float simplePerlin3D4_g53 = snoise( float3( uv_TexCoord3_g53 ,  0.0 ) );
			float2 appendResult6_g53 = (float2(simplePerlin3D4_g53 , simplePerlin3D4_g53));
			float4 appendResult572 = (float4(appendResult6_g53 , 1.0 , 0.0));
			...
			float temp_output_2_0_g54 = _EyeShadingPower;
			...
			float3 eyeShading672 = ( ( temp_cast_6 * temp_output_2_0_g54 ) + appendResult7_g54 );
			...
			float dotResult4_g48 = dot( ase_worldlightDir , temp_cast_9 );
			#if defined(LIGHTMAP_ON) && ( UNITY_VERSION < 560 || ( defined(LIGHTMAP_SHADOW_MIXING) && !defined(SHADOWS_SHADOWMASK) && defined(SHADOWS_SCREEN) ) )//aselc
			float4 ase_lightColor = 0;
			#else //aselc
			float4 ase_lightColor = _LightColor0;
			#endif //aselc
			float lerpResult968 = lerp( _CustomPupilSize , ( _CustomPupilSize * ( dotResult4_g48 - (-1.0 + (ase_lightColor.a - 0.0) * (1.0 - -1.0) / (1.0 - 0.0)) ) ) , _PupilAffByLightDir);
			...
			float dotResult4_g47 = dot( ase_worldlightDir , temp_cast_12 );
			float clampResult545 = clamp( ( ( temp_output_692_0 * ( dotResult4_g47 - (-1.0 + (ase_lightColor.a - 0.0) * (1.0 - -1.0) / (1.0 - 0.0)) ) ) * IrisPupil_MASK585 ) , 0.0 , 99.0 );
			...
			float4 clampResult478 = clamp( ( ( 1.0 * dotResult5_g50 ) * PupilMaskArea625 ) , temp_cast_14 , float4( 1,1,1,0 ) );
			...
			float3 temp_cast_17 = (pow( ( clampResult7_g51 * clampResult8_g51 ) , _EyeShadingPower )).xxx;
			...
			float4 lerpResult568 = lerp( ( temp_output_326_0 * ( clampResult478 * float4( ( ( temp_cast_17 * temp_output_2_0_g52 ) + appendResult7_g52 ) , 0.0 ) ) ) , LimbalRing_Color619 , eyeLimbalRingPower612);
			...
			float DLightSourcePower1019 = _DirectionalLightSourcePower1;
			o.Emission = ( lerpResult889 * _FinalEmissive * DLightSourcePower1019 ).rgb;
...
/*ASEBEGIN
Version=18800
1920;30;1920;998;2814.661;1763.42;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;267;-3459.916,-621.3807;Float;False;Property;_EyeSize;EyeSize;12;0;Create;True;0;0;0;False;0;False;1;0.91;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.CommentaryNode;922;-6667.985,-2373.734;Inherit;False;473.0703;241.1963;UV positional Adjust;3;920;919;921;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;920;-6624.067,-2231.535;Inherit;False;Property;_MasterYAdjust;MasterYAdjust;43;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;919;-6613.598,-2313.73;Inherit;False;Property;_MasterXAdjust;MasterXAdjust;42;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.DynamicAppendNode;921;-6365.777,-2284.538;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;923;-6148.291,-2269.205;Inherit;False;MasterUVAdjust;-1;True;1;0;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;967;-4865.677,-1235.61;Inherit;False;PupilAffectedByLight_float;-1;;48;676c5e5a2752c454fab10b64fa534af1;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;901;-4868.911,-1399.709;Float;False;Property;_CustomPupilSize;CustomPupilSize;26;0;Create;True;0;0;0;False;0;False;1;0.613;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;694;-6312.691,-1628.457;Inherit;False;PupilAffectedByLight_float;-1;;47;676c5e5a2752c454fab10b64fa534af1;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;970;-4888.9,-1141.837;Inherit;False;Property;_PupilAffByLightDir;PupilAffByLightDir;28;0;Create;True;0;0;0;False;0;False;0;0.308;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;543;-4922.593,-1036.299;Float;False;Property;_PupilAutoDilateFactor;PupilAutoDilateFactor;27;0;Create;True;0;0;0;False;0;False;0;0.4;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TFHCRemapNode;965;-3872.513,-1285.458;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;-15;False;4;FLOAT;-2.5;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;328;-4232.978,-1364.613;Float;False;Property;_IrisPupilBond;Iris-Pupil-Bond;24;0;Create;True;0;0;0;False;0;False;0.017;0.0148;0;0.1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;247;-3494.194,-772.5389;Float;False;Property;_IrisSize;IrisSize;13;0;Create;True;0;0;0;False;0;False;1;5.96;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;257;-5668.911,-1030.676;Float;False;Property;_PupilParallaxHeight;PupilParallaxHeight;31;0;Create;True;0;0;0;False;0;False;2.5;1.15;0;8;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;939;-2785.274,1864.085;Inherit;False;Property;_IrisYAdjustFactor;IrisYAdjustFactor;47;0;Create;True;0;0;0;False;0;False;1;4;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;938;-2785.274,1787.085;Inherit;False;Property;_IrisXAdjustFactor;IrisXAdjustFactor;46;0;Create;True;0;0;0;False;0;False;1;4;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;959;-3249.287,-1547.853;Inherit;False;Property;_PupilParalaxFactor;PupilParalaxFactor;48;0;Create;True;0;0;0;False;0;False;0;0.52;-2;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;916;-3018.992,-1182.242;Inherit;False;Property;_PupilXAdjustFactor;PupilXAdjustFactor;44;0;Create;True;0;0;0;False;0;False;1;14;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;917;-3026.992,-1108.242;Inherit;False;Property;_PupilYAdjustFactor;PupilYAdjustFactor;45;0;Create;True;0;0;0;False;0;False;1;14;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;187;-1915.38,1314.087;Float;False;Property;_IrisExtraColorAmountA;IrisExtraColor-Amount(A);6;0;Create;True;0;0;0;False;0;False;0.08088237,0.07573904,0.04698314,0.591;0.2333567,0.4899738,0.7169812,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.GetLocalVarNode;925;-3045.821,-965.9701;Inherit;False;923;MasterUVAdjust;1;0;OBJECT;;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;904;-3093.447,-1342.353;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;6,6;False;1;FLOAT2;-2.5,-2.5;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;170;-1908.036,772.9764;Float;False;Property;_EyeVeinColorAmountA;EyeVeinColor-Amount(A);7;0;Create;True;0;0;0;False;0;False;0.375,0,0,0;0.415094,0.01244791,0,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;929;-2660.9,-1043.553;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.OneMinusNode;595;-2446.204,695.3149;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;126;-706.0718,1582.184;Float;False;Property;_IrisBaseColor;IrisBaseColor;5;0;Create;True;0;0;0;False;0;False;0.4999702,0.5441177,0.4641004,1;0.1381716,0.1829867,0.2547167,0.9372549;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;133;-3418.101,633.1917;Float;False;Property;_EyeBallColorGlossA;EyeBallColor-Gloss(A);4;0;Create;True;0;0;0;False;2;Header(Color Customization);Space(6);False;1,1,1,0.853;0.7924528,0.7588109,0.7588109,0.8666667;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;976;-2175.377,2054.262;Inherit;False;Property;_causticAdjustfactor;causticAdjustfactor;49;0;Create;True;0;0;0;False;0;False;0;-0.153;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;600;-2446.386,-1149.092;Inherit;False;585;IrisPupil_MASK;1;0;OBJECT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.OneMinusNode;285;-2209.06,-1181.585;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;896;-2396.268,-1386.538;Inherit;True;Property;_PupilTexture;PupilTexture;25;0;Create;True;0;0;0;False;0;False;-1;None;1cffead11a05e6149b5ffb81ea939284;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;759;-803.2366,2391.976;Inherit;False;ConstantBiasScale;-1;;49;63208df05c83e8e49a48ffbdce2e43a0;0;3;3;FLOAT;0;False;1;FLOAT;0.5;False;2;FLOAT;1.25;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;50;-764.0728,2238.058;Float;False;Property;_CausticPower;CausticPower;21;0;Create;True;0;0;0;False;0;False;17;2.56;0.5;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ClampOpNode;905;-1626.555,-1282.055;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;1,1,1,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;625;-1376.604,-1293.529;Float;False;PupilMaskArea;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;489;594.1643,1489.961;Float;False;InstancedProperty;_MinimumGlow;MinimumGlow;35;0;Create;True;0;0;0;False;0;False;0.2;0.664;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;750;-326.8658,2509.578;Float;False;Property;_CausticFX_inDarkness;CausticFX_inDarkness;22;0;Create;True;0;0;0;False;0;False;17;1.148;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;647;2707.268,1444.284;Float;False;Property;_PupilColorEmissivenessA;PupilColor-Emissiveness(A);23;0;Create;True;0;0;0;False;2;Header(Pupil Control);Space(6);False;0,0,0,0;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;669;-43.51121,-496.9287;Inherit;False;MicroScatterScale_vec2;36;;53;27afac86e902b3f4680f2698fbeab237;0;0;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;483;-13.7304,2848.903;Inherit;False;Lerp White To;-1;;54;047d7c189c36a62438973bad9d37b1c2;0;2;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.CommentaryNode;894;5576.33,1729.3;Inherit;False;707.2163;329.385;SelfGlowEffect;5;890;892;889;893;1020;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1018;5422.125,787.1498;Inherit;False;Property;_DirectionalLightSourcePower1;DirectionalLightSourcePower;40;0;Create;True;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;890;5640.33,1876.575;Inherit;False;Property;_EmissiveAdjust;EmissiveAdjust;39;0;Create;True;0;0;0;False;0;False;0.85;0.757;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;1019;5769.795,785.2419;Inherit;False;DLightSourcePower;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;789;3885.831,1021.573;Float;False;Property;_SubSurfaceFromDirectionalLight;SubSurfaceFromDirectionalLight;50;0;Create;True;0;0;0;False;0;False;0.5;0.183;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;1020;6003.389,1973.823;Inherit;False;1019;DLightSourcePower;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;892;5641.757,1953.663;Inherit;False;Property;_FinalEmissive;FinalEmissive;41;0;Create;True;0;0;0;False;0;False;2;0.78;0;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;893;6114.546,1816.515;Inherit;False;3;3;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;6502.902,1550.51;Float;False;True;-1;2;ASEMaterialInspector;0;0;Standard;RRF_HumanShaders/EyeShaders/EyeShader_Model4;False;False;False;False;False;False;False;False;False;False;False;False;False;True;False;False;False;False;False;False;False;Back;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Opaque;0.5;True;True;0;False;Opaque;;Geometry;ForwardOnly;14;all;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;True;0;0;False;-1;0;False;-1;0;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;-1;-1;-1;-1;0;False;0;0;False;-1;-1;0;False;-1;0;0;0;False;0.1;False;-1;0;False;-1;False;16;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=BF0FD8E446EC91CAAC1F6333099538EB6DFF4EAD